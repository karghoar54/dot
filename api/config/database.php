...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'fmcsa' => [
            'driver' => 'sqlsrv',
            'host' => env('FMCSA_DB_HOST', 'localhost'),
            'port' => env('FMCSA_DB_PORT', '1433'),
            'database' => env('FMCSA_DB_DATABASE', 'forge'),
            'username' => env('FMCSA_DB_USERNAME', 'forge'),
            'password' => env('FMCSA_DB_PASSWORD', ''),
            'charset' => 'utf8',
            'prefix' => '',
            'prefix_indexes' => true,
            'encrypt' => env('FMCSA_DB_ENCRYPT', 'yes'),
