...
return [
    ...
    'auth' => [
        ...
        'use_value' => env('SCRIBE_AUTH_KEY', 'Bearer {YOUR_AUTH_TOKEN}'),
        ...
        'extra_info' => 'Use the login endpoint to obtain a Bearer token. Include it as `Authorization: Bearer {token}` in your requests.',
    ],
    ...
    'postman' => [
        'enabled' => true,
        'url' => '/storage/scribe/collection.json',
